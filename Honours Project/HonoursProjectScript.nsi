...
!define APPNAME "Honours Project"
!define COMPANYNAME "Ruairi O'Keefe"
!define DESCRIPTION "Aerodynamics simulation"
...
section "install"
	...
	file "x64\Release\Honours Project.exe"
...
#	File /r "include\"
	...
	writeUninstaller "$INSTDIR\HonoursProjectUninstall.exe" 
	# Start Menu
	createDirectory "$SMPROGRAMS\${COMPANYNAME}"
	createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\Honours Project.exe"
...
#	rmDir $INSTDIR\include
	...
	delete $INSTDIR\HonoursProjectUninstall.exe
